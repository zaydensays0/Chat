...
import { Send, CornerDownLeft, User } from 'lucide-react';
    ...
    try {
      ...
      if (characterData) {
        ...
        if (messages.length === 0) {
            setMessages([{ role: 'model', content: `Hello! I'm ${parsedCharacter.name}. It's so nice to finally meet you. What's on your mind?`}]);
        }
      } else {
        router.replace('/');
      }
